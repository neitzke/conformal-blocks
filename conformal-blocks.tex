...
Thus for $\chi \in \vrep$ we will have
...
Here is a construction of chiral correlation functions. \fixme{check}
Define
\[
W(i_1, \dots, i_m) =\
...
\ \prod_{\alpha=1}^s \left( \frac{1}{2 \abs{C_\alpha}} \sum_{\text{orderings }\mathbf{i}\text{ of }C_\alpha} W(\mathbf{i}) \right) \, .
\]
For example,
\begin{equation}
