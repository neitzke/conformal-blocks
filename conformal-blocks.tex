...
\begin{exercise} Because $\Delta_2 = 0$ at $k = 1$, the ideal $I$ must have a nontrivial grade $2$ subspace.
...
\begin{exercise} Similarly to the previous exercise, find a vector at grade $2$ which generates a nontrivial ideal at $k = -2$.
\end{exercise}
...
The left side can be written as \fixme{make figure with contours}
\begin{equation}
