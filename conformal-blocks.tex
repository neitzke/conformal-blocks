...
with markings as above, where there is at least one marked point.
The space of conformal blocks for $V^k(\fg)$ on $C$ is canonically isomorphic to the space of chiral correlation systems
for $V^k(\fg)$ on $C$.
\end{prop}
