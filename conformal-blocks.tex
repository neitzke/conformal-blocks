...
\begin{equation} \label{eq:y-series}
  Y(a,z) b = \sum_{n \in \bbZ} z^{-n-1} a_{(n)} \chi
\end{equation}
...
a Lie subalgebra of $\End(\vertex)$, with
...
Finally we briefly discuss modules:
...
\fixme{Now explain how a chiral correlation system gives a 
functional on a tensor product of copies of $\vertex$}
...
\subsection{Conformal blocks for affine vertex algebras}
