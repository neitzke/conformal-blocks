...
\begin{exercise} Calculate the determinant $\Delta_2$ by hand. (This seems tedious, but maybe fun to do once?)
\end{exercise}
...
we conclude that a chiral correlation system is uniquely determined by the values $\Phi(m \otimes \vac)$ for $m \in M$,
...
with all eigenvalues integers and bounded below. In that case $\fG_+$ acts locally nilpotently and $\fG_0$
