...
I'll try to lay out a few of them in the second part of this
introduction.
...
$n \ge 0$.
We won't give the complete construction now but name
three main examples: 
\begin{enumerate}
...
Suppose $\vertex = \Heis$ and $C = \bbC \bbP^1$,
...
Now let's go back to general $\vertex$ for a little while.

But suppose that $\vertex$ is \ti{conformal}, i.e. it 
contains a copy of $\Vir^c$. This is true for $V^k(\fg)$ 
as long as $k \neq -h^\vee$).
