\begin{figure}[h]
  ...
  \begin{tikzpicture}[scale=1.0, line cap=round, line join=round]
    ...
    \begin{scope}
      \clip (C) circle (\R);
      \begin{scope}[even odd rule]
        \clip (-2.8,-2.8) rectangle (2.8,2.8) (A) circle (\R);
    ...
    \end{scope}
  \end{tikzpicture}
  \caption{Cover by patches $U_\alpha$ and shrunken sets. After choosing an ordering on the cover, the sets $R_\alpha = V_\alpha \setminus \bigcup_{\gamma < \alpha} V_\gamma$ give a partition of the surface, and the contours $c_{\alpha\beta}$ are the interfaces between $R_\alpha$ and $R_\beta$, oriented as boundary components of $R_\alpha$.}
\end{figure}
