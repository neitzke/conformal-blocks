\begin{figure}[h]
  ...
  \begin{tikzpicture}[scale=1.0, line cap=round, line join=round]
    ...
    % intersection contours c_{alpha beta} = \partial V_\alpha \cap U_\beta
    ...
    \begin{scope}[xshift=5.2cm]
      ...
      % contour c_{12} = \partial V_1 \cap U_2 (schematic loop in the annulus)
      \begin{scope}
        \clip (B2) circle (\Rtwo);
    ...
    \end{scope}
  \end{tikzpicture}
  \caption{Cover by patches $U_\alpha$ and shrunken sets; the contours $c_{\alpha\beta}=\partial V_\alpha \cap U_\beta$ run along the overlaps.}
\end{figure}
